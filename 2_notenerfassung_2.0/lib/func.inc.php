...
function validateEmail($email)
{
    ...
    //mit der php-Methode "filter_var" kann überprüft werden, ob die Email-Adresse gültig ist.
    //Sie liefert true zurück, wenn die Mail-Adresse gültig ist und false wenn nicht.
